...
public class MemberLoginController {
	...
	@PostMapping
	public String login(MemberLoginRequest loginRequest, HttpServletResponse res, HttpSession session) throws Exception {
		// System.out.println(loginRequest);
		// Login Service의 메소드는 view의 정보를 반환
		// 실패 했을 때 view
		// 성공 했을 때 view => redirect 
		return loginService.login(loginRequest, session, res);
	}
